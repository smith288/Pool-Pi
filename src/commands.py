MAX_SEND_ATTEMPTS = 50  # Max number of times command will be attempted
...
button_value = {
    ...
    "heater1": b"\x10\x02\x00\x02\x01\x00\x00\x04\x00\x00\x00\x04\x00\x00\x00\x1d\x10\x03",
    "pool": b"\x10\x02\x00\x02@\x00@\x00\x00\x94\x10\x03",
    "menu": b"\x10\x02\x00\x02\x02\x00\x02\x00\x00\x18\x10\x03",
    "plus": b"\x10\x02\x00\x02 \x00 \x00\x00T\x10\x03",
    "minus": b"\x10\x02\x00\x02\x10\x00\x00\x10\x00\x00\x004\x10\x03",
    "left": b"\x10\x02\x00\x02\x04\x00\x04\x00\x00\x1c\x10\x03",
    "right": b"\x10\x02\x00\x02\x01\x00\x01\x00\x00\x16\x10\x03",
}
